...
@section('header')
    <header class="flex justify-between items-center px-10 py-6">
        ...
        <div class="block">
            <a href="{{ route('users.create') }}" class="v-button button-default">Create New User</a>
        </div>
    </header>
@endsection
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('users.show', $user->id) }}" class="text-indigo-600 hover:text-indigo-900 pr-3">View</a>
